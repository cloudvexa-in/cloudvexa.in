          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-lg opacity-80 leading-relaxed">
                ...
                scalable digital solutions that drive growth, enhance
                efficiency, and create lasting value. We strive to be the
                trusted technology partner that transforms visions into reality.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-lg opacity-80 leading-relaxed">
                ...
                and positive impact on the digital landscape. We envision a
                future where technology seamlessly enhances every aspect of
                business.
              </p>
            </motion.div>
          </div>
        ...
        <div className="container-custom">
          ...
          >
            ...
            <p className="text-lg opacity-80 max-w-2xl mx-auto mb-8">
              ...
              digital solutions. We&apos;re united by our passion for technology
