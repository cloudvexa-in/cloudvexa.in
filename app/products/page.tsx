...
const services = [
  {
    ...
    description:
      "End-to-end custom software development tailored to your business needs. From concept to deployment, we build scalable and robust applications.",
    features: [
  ...
  },
  {
    ...
    description:
      "Comprehensive quality assurance and testing services to ensure your software is bug-free, secure, and performs flawlessly.",
    features: [
      "Automated testing",
      "Performance testing",
      "Security testing",
  ...
  },
  {
    ...
    description:
      "Cutting-edge AI solutions and intelligent agents that automate processes, enhance decision-making, and drive innovation.",
    features: [
  ...
  },
  {
    ...
    description:
      "Enterprise-grade security solutions to protect your digital assets, ensure compliance, and maintain business continuity.",
    features: [
  ...
  },
  {
    ...
    description:
      "Data-driven SEO strategies to improve your search rankings, increase organic traffic, and boost your online visibility.",
    features: [
