                ...
                <div className="container-custom section-padding relative z-10 text-center">
                    ...
                    >
                        ...
                        >
                            ...
                            <span className="gradient-text">Secure</span> & <span className="gradient-text">Scalable</span><br />
                            Digital Solutions
                        </motion.h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                        ...
                        >
                            <h2 className="text-4xl md:text-5xl font-bold mb-6">
                                Experience the <span className="gradient-text">Cloudvexa</span> Advantage
                            </h2>
                            <p className="text-lg opacity-80 mb-8">
                                Partner with us for a seamless journey from concept to deployment
                                and beyond. We&apos;re committed to your success.
                            </p>
                        ...
                        >
                            {benefits.map((benefit, index) => (
                                ...
                                >
                                    <CheckCircle2 size={20} className="text-neon-cyan flex-shrink-0" />
