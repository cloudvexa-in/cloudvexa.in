...
const offices = [
  {
    ...
    mapsUrl:
      "https://www.google.com/maps/dir/?api=1&destination=Unit+101+Oxford+Towers+139%2F88+HAL+Old+Airport+Road+Bangalore+560008",
  },
];
        ...
        <div className="container-custom">
          ...
          >
            ...
            <div className="w-full h-96 bg-gradient-to-br from-deep-blue-300 to-deep-blue-100 flex items-center justify-center relative">
              <iframe
                ...
                marginHeight={0}
                marginWidth={0}
                src="https://maps.google.com/maps?width=100%25&amp;height=100%25&amp;hl=en&amp;q=Oxford%20Towers,%20Bangalore+(Cloudvexa)&amp;t=&amp;z=15&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                className="z-10 absolute inset-0 w-full h-full"
                style={{
                  filter: "grayscale(1) invert(0.9) contrast(1.2) opacity(0.8)",
                }}
                title="Cloudvexa Location"
              />
          ...
          <div className="flex flex-wrap justify-center gap-8">
            {offices.map((office, index) => (
              <motion.div
                key={office.city}
                className="glass-card group w-full md:w-[350px]"
                initial={{ opacity: 0, y: 30 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
              ...
              >
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-start gap-3">
                    <Navigation
                      size={16}
                      className="text-neon-cyan mt-1 flex-shrink-0"
                    />
